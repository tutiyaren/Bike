...
class SceneryPostRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            'area' => 'required',
            'scenery_genre' => 'required',
            'title' => 'required|string|max:50',
            'content' => 'required|string|max:255',
            'image1' => 'required|image|mimes:jpeg,png,jpg,git|max:2048',
    ...
    public function messages()
    {
        return [
            ...
            'scenery_genre.required' => 'ジャンルを選択してください。',
